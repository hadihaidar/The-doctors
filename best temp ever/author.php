						...
						<div class="tabs-content clearfix">
							<div class="tab-info active">
								<div class="row">
									...
									// 	$id =$rows['ID'];
									// 		$media=$db->query("SELECT * FROM media WHERE (PostID= $id ");
									// 		if ($media->rowCount() ==0){	//no media for this post so it is just text
									// 			echo '	<div class="col-ml-12 col-xs-6 col-sm-4">
									// 					<div class="be-post">
