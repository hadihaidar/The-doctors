				...
				<div class="col-md-3 col-md-pull-9 left-feild">
					...
					<div class="be-user-block">
						...
						<div class="be-user-activity-block">
							...
							<div class="col-lg-6">
								<?php 
								/*No need for the php but only for the comment
								Should check if there is an existing friend request
								if yes from the sender side put a delete request button
								if yes from the reciever side put accept reject
								if No put add button
								*/?>				
								<a href="Add.php?from=<?=$_SESSION['user']?>&to=<?=$_REQUEST['account']?>" class="be-user-activity-button"><i class="fa fa-plus"></i>Add</a>
							</div>
							<div class="col-lg-6">
